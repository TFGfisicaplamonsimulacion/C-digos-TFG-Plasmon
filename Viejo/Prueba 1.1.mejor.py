...
####################################
# CAMBIOS FRENTE AL ANTERIOR, AHORA EL LASER SE ESTÁ APLICANDO COMO UNA GAUSIANA SOBRE TODA LA PLACA
#PROBLEMA ESO ES MÁS CARO EN CALCULOS
#####################################
#parametros
...
X, Y = np.meshgrid(x, y)
laser = np.exp(-((X-cordX)**2 + (Y-cordY)**2))*dt  # Perfil gaussiano del laser
...
#problema no es circular del todo el laser, la region en la que lo aplico es cuadrada xD. ARREGLADO!!!
